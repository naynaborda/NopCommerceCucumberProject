  ...
  Scenario: To Verify User should able to add virtual gift card in the cart send an email a friend and see confirmation message
    ...
    Scenario Outline: To Verify User should able to add virtual gift card in the cart and send an email a friend and see confirmation message
      ...
      Examples1:
        ...
        |Ram      |Sita    |ramsita@test.com |sitaram |sitaram        |
      Examples2:
      |Recipient's Name|Recipient's Email|User Name|User Email      |
      |Sonal           |sonal@test.com   |Ram Sita |ramsita@test.com|
      Examples3:
      |Friend's email |User email address|Personal message|
      |sonal@test.com |ramsita@test.com |Birthday Gift   |
